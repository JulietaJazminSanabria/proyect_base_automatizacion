...
Feature: Notificaciones y Alertas
  ...
  --HappyPath
  Escenario: Enviar una notificación push después de una transferencia exitosa
  ...
  --negative
  Escenario: No enviar una notificación push cuando el canal está desactivado
  ...
  --edge_case
  Escenario: Evitar notificaciones duplicadas ante el reprocesamiento de un evento
    Given el usuario tiene habilitadas las notificaciones push
